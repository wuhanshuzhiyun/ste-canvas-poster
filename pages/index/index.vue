	...
	},
	{
		...
		schema: {
			...
			views: [
				...
				{
					type: 'view',
					css: { left: 40, top: 280, width: 630, height: 480, backgroundColor: 'rgba(255,255,255,0.95)', borderRadius: 24 },
					views: [
						{
							type: 'image',
							src: '{{productImage}}',
						...
						{ type: 'text', text: '{{productName}}', css: { left: 30, top: 360, fontSize: 40, color: '#2C3E50', fontWeight: 'bold' } },
						{ type: 'text', text: '{{productDesc}}', css: { left: 30, top: 420, fontSize: 28, color: '#7F8C8D' } }
					]
				},
				{ type: 'qrcode', src: '{{qrcodeUrl}}', css: { left: 255, top: 780, width: 200, height: 200 } }
			]
		},
		data: {
